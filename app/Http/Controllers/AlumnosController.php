...
{
    public function index(Request $request) //Función para mostrar listado de alumnos
    {
      $contador=1; //Variable para mostrar un correlativo
      ...
      if($request->nombres){ //Busqueda por nombre
